...
public class XeventsImpl implements Xevents {
    ...
    {
        return ForgeHooksClient.renderBlockOverlay(player, blockState, blockPos) != null;
    }
    ...
    {
        return ForgeHooksClient.renderWaterOverlay(player, playerRenderState) != null;
    }
    ...
    public boolean extractFireOverlay(
        ...
        float playerPartialTick)
    {
        return ForgeHooksClient.renderFireOverlay(player) != null;
    }
}
