...
public class VREvent_ShowUI_t extends Structure
{
    ...
    public static class ByReference extends VREvent_ShowUI_t implements Structure.ByReference
    {
    }

    public static class ByValue extends VREvent_ShowUI_t implements Structure.ByValue
    {
    }
}
