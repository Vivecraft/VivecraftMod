...
public class VREvent_HDCPError_t extends Structure
{
    ...
    public static class ByReference extends VREvent_HDCPError_t implements Structure.ByReference
    {
    }

    public static class ByValue extends VREvent_HDCPError_t implements Structure.ByValue
    {
    }
}
