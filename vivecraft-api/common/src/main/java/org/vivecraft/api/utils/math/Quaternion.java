package org.vivecraft.api.utils.math;
...
public class Quaternion
{
    ...
    public Quaternion(org.vivecraft.api.utils.lwjgl.Matrix4f matrix)
    {
        this(matrix.m00, matrix.m01, matrix.m02, matrix.m10, matrix.m11, matrix.m12, matrix.m20, matrix.m21, matrix.m22);
    }
    ...
    public Quaternion rotate(Axis axis, float degrees, boolean local)
    {
        ...
        {
            org.vivecraft.api.utils.lwjgl.Matrix4f matrix4f = this.getMatrix();
    ...
    public org.vivecraft.api.utils.lwjgl.Matrix4f getMatrix()
    {
        org.vivecraft.api.utils.lwjgl.Matrix4f matrix4f = new org.vivecraft.api.utils.lwjgl.Matrix4f();
