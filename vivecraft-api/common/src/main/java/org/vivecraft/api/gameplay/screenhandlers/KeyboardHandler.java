package org.vivecraft.api.gameplay.screenhandlers;
...
import org.vivecraft.api.gui.GuiKeyboard;
import org.vivecraft.api.gui.PhysicalKeyboard;
...
public class KeyboardHandler
{
    ...
    public static org.vivecraft.api.utils.math.Matrix4f Rotation_room = new org.vivecraft.api.utils.math.Matrix4f();
    ...
    public static void orientOverlay(boolean guiRelative)
    {
        ...
        if (Showing)
        {
            ...
            if (dh.vrSettings.physicalKeyboard)
            {
                ...
                Rotation_room = org.vivecraft.api.utils.math.Matrix4f.rotationY(f);
                Rotation_room = org.vivecraft.api.utils.math.Matrix4f.multiply(Rotation_room, Utils.rotationXMatrix(2.5132742F));
            }
            ...
            else
            {
                ...
                Rotation_room = org.vivecraft.api.utils.math.Matrix4f.rotationY(f2);
            }
        }
    }
