...
public class VREvent_ShowDevTools_t extends Structure
{
    ...
    public static class ByReference extends VREvent_ShowDevTools_t implements Structure.ByReference
    {
    }

    public static class ByValue extends VREvent_ShowDevTools_t implements Structure.ByValue
    {
    }
}
