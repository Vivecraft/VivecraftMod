...
public class Compositor_FrameTiming extends Structure
{
    ...
    public static class ByReference extends Compositor_FrameTiming implements com.sun.jna.Structure.ByReference
    {
    }

    public static class ByValue extends Compositor_FrameTiming implements com.sun.jna.Structure.ByValue
    {
    }
}
