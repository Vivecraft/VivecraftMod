    ...
    public void init()
    {
        ...
        try
        {
            ...
            if (inputstream != null)
            {
                ...
                this.prepare();
                ((GameRendererExtension) this.mc.gameRenderer).setMenuWorldFastTime((new Random()).nextInt(10) == 0);
            }
            else
            {
    ...
    */}
    ...
    public static class MenuCloudRenderer
    {
        ...
        public boolean shouldUpdateGlList(float posY)
        {
            ...
            {
                boolean flag = this.cloudPlayerY < 128.0D; //+ this.mc.options.ofCloudsHeight * 128.0D; TODO Optifine
