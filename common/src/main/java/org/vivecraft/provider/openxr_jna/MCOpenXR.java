...
import org.vivecraft.provider.openxr_jna.control.TrackpadSwipeSampler;
...
public class MCOpenXR extends MCVR
{
    ...
    private XrActionStatePose poseData;
    private XrApplicationInfo vrApplications;
    XrInstanceCreateInfo xrInstanceCreateInfo;
    XrSessionCreateInfo xrSessionCreateInfo;
    XrInstance xrInstance;
    XrSession xrSession;
    XrActiveActionSet activeActionSet;
    XrCompositionLayerAlphaBlendFB vrCompositor;

    public MCOpenXR(Minecraft mc, ClientDataHolder dh)
    {
        super(mc, dh);
        ome = this;
        ...
        for (int i = 0; i < 3; ++i)
        {
            ...
            this.poseData = new XrActionStatePose();
    ...
    public void poll(long frameIndex)
    {
        if (this.initialized)
        {
            this.paused = XR10.XR_SESSION_STATE_IDLE;
    ...
    private XrActiveActionSet[] getActiveActionSets()
    {
        ...
        this.activeActionSet = new XrActiveActionSet();
        this.activeActionSet.setAutoRead(false);
        this.activeActionSet.setAutoWrite(false);
        this.activeActionSet.setAutoSynch(false);
        XrActiveActionSet[] avractiveactionset_t = (XrActiveActionSet[])this.activeActionSet.toArray(arraylist.size());
    ...
    public void initializeXrInstance() {
        PointerBuffer pointerBuffer = null;
        XR10.xrCreateInstance(xrInstanceCreateInfo, pointerBuffer);
    }
    ...
    private void initializeXrSession()
    {
        this.vrsystem = null;
        PointerBuffer pointerBuffer = null;
        XR10.xrCreateSession(xrInstance, xrSessionCreateInfo, pointerBuffer);
