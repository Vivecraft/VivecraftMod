...
public class TrackpadSwipeSampler
{
    ...
    {
        MCOpenXR.get().getInputAction(MCOpenXR.get().keyTrackpadTouch).setCurrentHand(hand);

        if (MCOpenXR.get().getInputAction(MCOpenXR.get().keyTrackpadTouch).isButtonPressed())
        {
