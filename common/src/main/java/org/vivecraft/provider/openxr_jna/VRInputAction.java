...
public class VRInputAction
{
    ...
    public boolean isEnabled()
    {
        ...
        else
        {
            ...
            ControllerType controllertype = MCOpenXR.get().getOriginControllerType(i);
            ...
            {
                for (VRInputAction vrinputaction : MCOpenXR.get().getInputActions())
                {
    ...
    private void pressKey()
    {
        ...
        if (inputconstants$key.getValue() != -1 && !MCOpenXR.get().isSafeBinding(this.keyBinding)) //&& (!Reflector.ForgeKeyBinding_getKeyModifier.exists() || Reflector.call(this.keyBinding, Reflector.ForgeKeyBinding_getKeyModifier) == Reflector.getFieldValue(Reflector.KeyModifier_NONE)))
        {
