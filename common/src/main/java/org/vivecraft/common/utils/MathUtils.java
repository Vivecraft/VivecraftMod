...
public class MathUtils {
    ...
    public static final Vector4fc BLACK_TRANSPARENT = new Vector4f(0F, 0F, 0F, 0F);
    public static final Vector4fc BLACK_SOLID = new Vector4f(0F, 0F, 0F, 1F);
    public static final Vector4fc WHITE_SOLID = new Vector4f(1F, 1F, 1F, 1F);
