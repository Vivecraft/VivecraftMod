...
@ParametersAreNonnullByDefault public class Utils {
    ...
    public static Vector3dc forward() { return dforward; }
    public static Vector3dc backward() { return dbackward; }
    public static Vector3dc up() { return dup; }
    public static Vector3dc down() { return ddown; }
    public static Vector3dc right() { return dright; }
    public static Vector3dc left() { return dleft; }
