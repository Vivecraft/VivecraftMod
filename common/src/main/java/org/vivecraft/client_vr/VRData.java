...
//        this.g1 = new VRDevicePose(this, new Matrix4d(), dh.vr.getGesturePosition(1), dh.vr.getGestureVector(1));
        ...
        if(dh.vrSettings.seated) {
            ...
            this.t0 = new VRDevicePose(this, matrix4f, dh.vr.getAimSource(0).subtract(vec3).add(vec31), convertToVec3(new Vector3f(forward).mulProject(matrix4f)));
            this.t1 = new VRDevicePose(this, matrix4f1, dh.vr.getAimSource(1).subtract(vec3).add(vec31), convertToVec3(new Vector3f(forward).mulProject(matrix4f1)));
        }
