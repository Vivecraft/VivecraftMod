...
public class MenuWorldRenderer {
    ...
    public void render(PoseStack poseStack) {
        ...
        // rotate World
        poseStack.mulPose(Vector3f.YP.rotationDegrees(this.worldRotation));
    ...
    public Vec3 getSkyColor(Vec3 position) {
        ...
        if (!this.mc.options.hideLightningFlashes && this.skyFlashTime > 0) {
    ...
    public static class MenuFogRenderer {
        ...
        private void updateSurfaceFog() {
            ...
            if (OptifineHelper.isOptifineLoaded()) {
                    ...
                    .equals(DimensionType.OVERWORLD_EFFECTS))
                {
                    ...
                    .equals(DimensionType.END_EFFECTS))
                {
            ...
            if (OptifineHelper.isOptifineLoaded()) {
                    ...
                    .equals(DimensionType.END_EFFECTS))
                {
                    ...
                    .equals(DimensionType.NETHER_EFFECTS))
                {
        ...
        private void updateWaterFog(LevelReader levelIn) {
            ...
            int waterFogColor = levelIn.getBiome(new BlockPos(this.menuWorldRenderer.getEyePos())).value()
                .getWaterFogColor();
        ...
        public void setupFog(FogRenderer.FogMode fogMode) {
            ...
            if (fogType == FogType.LAVA) {
                ...
                Holder<Biome> holder = this.menuWorldRenderer.blockAccess.getBiome(
                    new BlockPos(this.menuWorldRenderer.getEyePos()));
        ...
        private FogType getEyeFogType() {
            ...
            if (this.menuWorldRenderer.areEyesInFluid(FluidTags.WATER)) {
                ...
                new BlockPos(this.menuWorldRenderer.getEyePos())).is(Blocks.POWDER_SNOW))
            {
