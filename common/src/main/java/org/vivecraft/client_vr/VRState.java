...
public class VRState {
     ...
     * @see org.vivecraft.mixin.client_vr.MinecraftVRMixin#vivecraft$captureMinecraftInstance(net.minecraft.client.Minecraft, com.llamalad7.mixinextras.injector.wrapoperation.Operation)
     */
    @Nonnull
    public static net.minecraft.client.Minecraft mc = net.minecraft.client.Minecraft.getInstance();
    /**
     * The VR Data Holder.
     *
     * @see org.vivecraft.mixin.client_vr.MinecraftVRMixin#vivecraft$captureMinecraftInstance(net.minecraft.client.Minecraft, com.llamalad7.mixinextras.injector.wrapoperation.Operation)
     */
    @Nonnull
    public static final ClientDataHolderVR dh = new ClientDataHolderVR();
