...
public class KeyboardHandler {
    ...
    public static void processBindings() {
        if (Showing) {
            ...
            i0 = (int) (clamp(0, GuiHandler.guiWidth, (int) UI.cursorX2) * (double) UI.width / (double) GuiHandler.guiWidth);
            i1 = (int) (clamp(0, GuiHandler.guiHeight, (int) UI.cursorY2) * (double) UI.height / (double) GuiHandler.guiHeight);
