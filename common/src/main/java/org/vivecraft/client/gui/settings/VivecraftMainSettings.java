...
public class VivecraftMainSettings extends GuiListScreen {
    ...
    protected List<BaseEntry> getEntries() {
        ...
        entries.add(new WidgetEntry(
            ...
            CycleButton.onOffBuilder(ClientDataHolderVR.getInstance().vrSettings.vrToggleButtonEnabled).displayOnlyValue().create(0, 0, WidgetEntry.valueButtonWidth, 20, Component.empty(), (cycleButton, object) -> {
        ...
        entries.add(new WidgetEntry(
            ...
            CycleButton.onOffBuilder(ClientDataHolderVR.getInstance().vrSettings.vrSettingsButtonEnabled).displayOnlyValue().create(0, 0, WidgetEntry.valueButtonWidth, 20, Component.empty(), (cycleButton, object) -> {
        ...
        entries.add(new WidgetEntry(
            ...
            new Builder<Boolean>(bool -> bool ? Component.translatable("vivecraft.options.left") : Component.translatable("vivecraft.options.right")).withValues(ImmutableList.of(Boolean.TRUE, Boolean.FALSE)).withInitialValue(ClientDataHolderVR.getInstance().vrSettings.vrSettingsButtonPositionLeft).displayOnlyValue().create(0, 0, WidgetEntry.valueButtonWidth, 20, Component.empty(), (cycleButton, object) -> {
