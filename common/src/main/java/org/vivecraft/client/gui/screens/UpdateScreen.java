...
public class UpdateScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Builder(Component.literal("Download from Modrinth"),
            ConfirmLinkScreen.confirmLink("https://modrinth.com/mod/vivecraft", this, true))
            .pos(this.width / 2 - 155, this.height - 56)
            .size(150, 20)
            .build());

        this.addRenderableWidget(new Builder(Component.literal("Download from Curseforge"),
