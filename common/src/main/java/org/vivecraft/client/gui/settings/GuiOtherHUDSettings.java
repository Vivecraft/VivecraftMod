...
public class GuiOtherHUDSettings extends org.vivecraft.client.gui.framework.GuiVROptionsBase {
    ...
    public void init() {
        ...
        super.init(
            ...
            ClientDataHolderVR.getInstance().vrSettings.chatNotifications == ChatNotifications.SOUND || ClientDataHolderVR.getInstance().vrSettings.chatNotifications == ChatNotifications.BOTH ? VrOptions.CHAT_NOTIFICATION_SOUND : VrOptions.DUMMY,
